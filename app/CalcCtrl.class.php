...
class CalcCtrl
{
    ...
    public function validate()
    {
        ...
        if ($this->form->loanValue == null) {
            $this->msgs->addError('Brak kwoty pożyczki.');
        }

        if ($this->form->yearsOfCredit == null) {
            $this->msgs->addError('Brak czasu trwania pożyczki.');
        }

        if ($this->form->percent == null) {
            $this->msgs->addError('Brak stopy oprocentowania.');
        }
    ...
    public function generateView()
    {
        ...
        $smarty->assign('page_title', 'Kalkulator w PHP');
